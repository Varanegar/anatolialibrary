...
{
    public class BasketManager : BaseManager<BaseDataAdapter<BasketViewModel>, BasketViewModel>
    {
        public static async Task SyncDataBase()
        {
            try
            {
                ...
                await LocalUpdateAsync(new UpdateCommand("products", new BasicParam("favorit", "0"), new BasicParam("count", "0")));
