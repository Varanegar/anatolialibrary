...
namespace ClientApp
{
    class Program
    {
        ...
        {
            var oauthClient = new OAuth2Client(new Uri("http://localhost:59822/oauth/token"));
            try
            {
                ...
                if (oauthresult.AccessToken != null)
                {
                    ...
                    var result = client.GetAsync("http://localhost:59822/api/accounts/user/anatoli").Result; 
