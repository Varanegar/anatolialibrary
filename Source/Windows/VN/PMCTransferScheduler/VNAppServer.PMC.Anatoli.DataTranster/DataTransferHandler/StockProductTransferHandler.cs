...
namespace VNAppServer.PMC.Anatoli.DataTranster
{
    public class StockTransferHandler
    {
        ...
        public static void UploadStockToServer(HttpClient client, string serverURI, string privateOwnerQueryString)
        {
            try
            {
                ...
                if (dbData != null)
                {
                    ...
                    string URI = serverURI + BaseInfo.SaveStockURI + privateOwnerQueryString;
