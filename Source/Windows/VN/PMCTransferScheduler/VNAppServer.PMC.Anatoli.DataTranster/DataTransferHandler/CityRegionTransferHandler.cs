...
namespace VNAppServer.PMC.Anatoli.DataTranster
{
    public class CityRegionTransferHandler
    {
        ...
        public static void UploadCityRegionToServer(HttpClient client, string serverURI, string privateOwnerId, string dataOwner, string dataOwnerCenter)
        {
            try
            {
