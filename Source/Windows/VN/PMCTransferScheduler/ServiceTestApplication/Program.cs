        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                if (oauthresult.AccessToken != null)
                {
                    ...
                    FiscalYearTransferHandler.UploadFiscalYearToServer(client, ServerURI, privateOwner, privateOwnerId);
                    ...
                    CustomerTransferHandler.UploadCustomerToServer(client, ServerURI, privateOwner, privateOwnerId);
                    log.Info("Transfer fiscal year");
                    FiscalYearTransferHandler.UploadFiscalYearToServer(client, ServerURI, privateOwner, privateOwnerId);
                    log.Info("Transfer supplier");
                    SupplierTransferHandler.UploadSupplierToServer(client, ServerURI, privateOwner);
