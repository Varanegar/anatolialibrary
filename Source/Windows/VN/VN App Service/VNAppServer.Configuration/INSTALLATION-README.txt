...
Connect to your newly installed VNAppServerConfiguration.s3db (using SQLite Administrator tool) 
...
Finally, update the app.config file to state the full path to your VNAppServerConfiguration.s3db file.  
