...
{
    public class SupplierRepository : AnatoliRepository<Supplier>, ISupplierRepository
    {
        #region Ctors
        public SupplierRepository() : this(new AnatoliDbContext()) { }
        public SupplierRepository(AnatoliDbContext context)
            : base(context)
        {
        }
        #endregion
