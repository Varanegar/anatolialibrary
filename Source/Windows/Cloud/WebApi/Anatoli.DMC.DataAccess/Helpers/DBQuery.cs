using Anatoli.DMC.ViewModels.BaseModels;
using System;
...
namespace Anatoli.DMC.DataAccess.Helpers
{
    ...
    {
        private static List<DMCDBQueryViewModel> queryList = new List<DMCDBQueryViewModel>();
        ...
        public static DBQuery Instance
        {
            get
            {
                if (instance == null)
                {
                    ...
                    {
                        var data = context.All<DMCDBQueryViewModel>(@"select UniqueId, QueryName, QueryTSQL from AnatoliQuery");
