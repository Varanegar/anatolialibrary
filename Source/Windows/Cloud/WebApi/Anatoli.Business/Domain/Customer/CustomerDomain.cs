...
{
    public class CustomerDomain : IBusinessDomain<Manufacture, ManufactureViewModel>
    {
        #region Properties
        ...
        public CustomerDomain(IManufactureRepository manufactureRepository, IPrincipalRepository principalRepository, IAnatoliProxy<Manufacture, ManufactureViewModel> proxy)
        {
            Proxy = proxy;
