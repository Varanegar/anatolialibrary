...
using WcfAppServer.ConsoleClient.ClientProxies;
using System.Data;
...
namespace WcfAppServer.ConsoleClient
{
    internal class Program
    {
                                           ...
                                           IAppServerAdmin adminClient)
        {
            ...
            foreach (var serviceConfig in configService.ListAll)
            ...
            Console.WriteLine(" or SQLiteConfigService.cs in the WcfAppServer.Configuration project.");
            Console.WriteLine();
        }
