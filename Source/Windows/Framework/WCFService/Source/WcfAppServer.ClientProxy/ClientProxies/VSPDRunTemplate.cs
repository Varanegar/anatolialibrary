...
namespace WcfAppServer.ClientProxy.ClientProxies
{
    ...
    public sealed class VSPDRunTemplate
    {
        private static VSPDRunTemplate instance = null;
        private SQLiteConfigService configService;
        private AppServerAdminClient adminClient;

        private VSPDRunTemplate()
        {
        ...
        public static VSPDRunTemplate Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new VSPDRunTemplate();
                }
                return instance;
            }
        }
        ...
        {
            throw new System.Exception("ExecuteReaderFromDB3 : " + aConnectionString);
